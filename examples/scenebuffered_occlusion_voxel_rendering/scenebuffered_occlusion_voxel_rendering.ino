// XYdraw library scenebuffered, occlusion voxel rendering
// ESP32
// Nemes Dániel
//
// This file demonstrates the scenebuffered, occlusion voxel rendering capability of the XYdraw library
//
...
void loop()
{
  ...
  // ── Render ──────────────────────────────────────────────────────────────────
  // Occlusion mode: polygons hide edges behind them.
  draw.clear_scenebuffer();
  draw.add_voxels_to_scenebuffer(voxels, X_SIZE, Y_SIZE, Z_SIZE, VOXEL_SIZE,
                                 GRID_X_POS, GRID_Y_POS, GRID_Z_POS);
  draw.render_scenebuffer((int)cam_x, (int)cam_y, (int)cam_z,
